  ...
  return (
    <div>
      {!photos ? (
        ...
        <div className="grid grid-cols-3 items-center gap-2 overflow-hidden rounded-xl border border-gray-200 bg-white p-2 md:gap-4 md:p-4">
          {photos.map(({ docId, caption, comments, imageSrc, likes }) => (
            <div>
              ...
              >
                <img
                  className="h-[115px] w-[191px] sm:h-[234px] sm:w-[234px] md:h-[310px] md:w-[310px]"
                  alt={caption}
                  src={imageSrc}
                />
      ...
      {!photos ||
        (photos.length === 0 && (
          <div className="rounded-xl border border-gray-200 bg-white p-2 text-center md:gap-4 md:p-4">
